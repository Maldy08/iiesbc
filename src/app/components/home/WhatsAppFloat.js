...
export default function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      className="group fixed bottom-6 right-6 z-50 inline-flex items-center gap-3 bg-[#25D366] hover:bg-[#1fb855] text-white pl-4 pr-5 py-3.5 rounded-full shadow-[0_20px_48px_-12px_rgba(37,211,102,0.55)] hover:shadow-[0_24px_56px_-12px_rgba(37,211,102,0.7)] transition-all duration-300 hover:-translate-y-0.5 animate-fade-in-up"
    >
      ...
      <span className="hidden sm:flex flex-col leading-tight">
        <span className="text-[10px] font-semibold uppercase tracking-widest text-white/80">Chatea ahora</span>
