        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div>
            <div className="mb-8">
              ...
              <p className="text-lg text-gray-600">Conoce los detalles de la Licenciatura en Criminología</p>
            </div>
          ...
          <div className="relative h-[600px] rounded-2xl overflow-hidden shadow-2xl">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
              <h3 className="text-3xl font-bold mb-2">Investiga el Crimen</h3>
              <p className="text-lg opacity-90">Aplica la ciencia a la justicia</p>
            </div>
          </div>
        </div>
      </section>
